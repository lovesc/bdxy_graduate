 ...
 * Generated at: 2020-05-02 06:38:32 UTC
...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<span>&nbsp;&nbsp;&nbsp;身 份：</span> <select>\n");
      ...
      out.write("\t\t\t\t\t\t<span>&nbsp;&nbsp;&nbsp;账 号：</span> <input type=\"text\" value=\"\"\n");
      out.write("\t\t\t\t\t\t\tplaceholder=\" &nbsp;请输入学号/工号\" id=\"userName\" class=\"userName\" />\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"password clearfix\">\n");
      out.write("\t\t\t\t\t\t<span>&nbsp;&nbsp;&nbsp;密 码：</span> <input type=\"password\"\n");
      out.write("\t\t\t\t\t\t\tvalue=\"\" placeholder=\" &nbsp;请输入密码\" id=\"password1\"\n");
      out.write("\t\t\t\t\t\t\tclass=\"password1\" />\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\tif (data.role == \"2\") {\n");
      out.write("\t\t\t\t\t\t\t\twindow.parent.location.href = \"index\";\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t\tif(data.role==\"3\"){\n");
      out.write("\t\t\t\t\t\t\t\twindow.parent.location.href = \"index1\";\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t\tif (data.role == \"1\") {\n");
      out.write("\t\t\t\t\t\t\t\twindow.parent.location.href = \"student\";\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t\treturn;\n");
      out.write("\t\t\t\t\t\t} else {\n");

 ...
 * Generated at: 2020-05-02 10:45:27 UTC
...
public final class register_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<div class=\"account clearfix\" id=\"college\">\n");
      ...
      out.write("\t\t\t\t\t\t<span>&nbsp;&nbsp;学&nbsp;&nbsp;号&nbsp;&nbsp;：</span> <input\n");
      out.write("\t\t\t\t\t\t\ttype=\"text\" placeholder=\" &nbsp;请输入学号\" id=\"studentid\"\n");
      out.write("\t\t\t\t\t\t\tname=\"studentid\" />\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"account clearfix\">\n");
      out.write("\t\t\t\t\t\t<span>&nbsp;&nbsp;姓&nbsp;&nbsp;名&nbsp;&nbsp;：</span> <input\n");
      out.write("\t\t\t\t\t\t\ttype=\"text\" placeholder=\" &nbsp;请输入姓名\" id=\"studentname\"\n");
      out.write("\t\t\t\t\t\t\tname=\"studentname\" />\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t<div class=\"password clearfix\">\n");
      out.write("\t\t\t\t\t\t<span>&nbsp;&nbsp;密&nbsp;&nbsp;码&nbsp;&nbsp;：</span> <input\n");
      out.write("\t\t\t\t\t\t\ttype=\"password\" value=\"\" placeholder=\" &nbsp;请输入密码\" id=\"password\"\n");
      out.write("\t\t\t\t\t\t\tname=\"password\" />\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t<div class=\"account clearfix\" id=\"sex\" style=\"top: 20px\">\n");
      out.write("\t\t\t\t\t\t<span>&nbsp;&nbsp;性&nbsp;&nbsp;别&nbsp;&nbsp;：</span> <select>\n");
      out.write("\t\t\t\t\t\t\t<option value=\"\">请选择</option>\n");
      ...
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"btn\">\n");
      out.write("\t\t\t\t\t\t<span id=\"login\"><a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/system/login\">去登录</a></span>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\tvar number = $(\"#college select\").val();\n");
      out.write("\t\t\t\t\t\t\t\tvar studentname = $(\"#studentname\").val();\n");
      out.write("\t\t\t\t\t\t\t\tvar studentid = $(\"#studentid\").val();\n");
      out.write("\t\t\t\t\t\t\t\tvar password = $(\"#password\").val();\n");
      out.write("\t\t\t\t\t\t\t\tvar sex = $(\"#sex select\").val();\n");
      ...
      out.write("\t\t\tvar sex = $(\"#sex select\").val();\n");
      out.write("\n");
      out.write("\t\t\tif (number == null || number == \"\") {\n");
      out.write("\t\t\t\talert(\"请选择院校\");\n");
      out.write("\t\t\t\treturn false;\n");
      out.write("\t\t\t}\n");
      out.write("\t\t\tif (studentname == null || studentname == \"\") {\n");

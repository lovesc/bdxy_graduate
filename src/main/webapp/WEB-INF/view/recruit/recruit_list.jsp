    ...
    $('#dataList').datagrid({ 
        ...
        columns: [[  
			{field:'chk',checkbox: true,width:50},
		        ...
		        {field:'name',title:'公司名称',width:100, sortable: true},
		        {field:'content',title:'招聘会信息',width:150, sortable: true},
		        {field:'address',title:'招聘会举办地点',width:100},
		        {field:'time',title:'招聘会举办时间',width:150, sortable: true,align:"center"},
    ...
    $("#addDialog").dialog({
  	...
  	$("#editDialog").dialog({
		...
		$("#search-btn").click(function() {
			$('#dataList').datagrid('reload', {
				time : $("#search-time").datebox('getValue'),
	...
	<div id="toolbar">
		...
		<div>
			<a id="delete" href="javascript:;" class="easyui-linkbutton"
				...
				公司查询:<select id="search-name" class="easyui-combobox"
	...
	<div id="addDialog" style="padding: 10px;">
		<form id="addForm" method="post">
			...
			<tr>
				...
				<tr>
					<td>招聘会内容:</td>
					<td><input class="easyui-textbox" name="content" id="add_content"
	    data-options="multiline:true" style="height:200px;width:200px">
	        </input></td>
				</tr>
				<tr>
					<td>招聘会地址:</td>
					<td><input id="add_address"
						style="width: 200px; height: 30px;" class="easyui-textbox"
						type="text" name="address"
						data-options="required:true, missingMessage:'请填写举办地点'" /></td>
				</tr>
				<tr>
					<td>招聘会时间:</td>
					<td><input id="add_time" class="easyui-datetimebox"
						name="time" data-options="required:true,showSeconds:false"
	...
	<div id="editDialog" style="padding: 10px">
		...
		<form id="editForm" method="post">
			...
			<tr>
				...
				<tr>
					<td>招聘会内容:</td>
					<td><input class="easyui-textbox" name="content" id="edit_content"
	          data-options="multiline:true" style="height:200px;width:200px">
	        </input></td>
				</tr>
				<tr>
					<td>招聘会地址:</td>
					<td><input id="edit_address"
						style="width: 200px; height: 30px;" class="easyui-textbox"
						type="text" name="address"
						data-options="required:true, missingMessage:'请填写举办地点'" /></td>
				</tr>
				<tr>
					<td>招聘会时间:</td>
					<td><input id="edit_time" class="easyui-datetimebox"
						name="time" data-options="required:true,showSeconds:false"
						value="" style="width: 150px"></input></td>
				</tr>
			</table>

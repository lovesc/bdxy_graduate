				...
				<div class="col-md-9">
					<div class="" style="margin-top: 20px">
						<span class="layui-breadcrumb" lay-separator=">>"> <a
							...
							href="${ctx}/recruit/torecruit">招聘会信息</a>- <a><cite>公告信息列表</cite></a>
						</span>
					</div>
					...
					<div style="margin-top: 40px">
						...
						<div class="container">
							...
							<div class="page-header" style="text-align: center">
								...
								<p>
									开始时间：
									<fmt:formatDate value="${recruit.time}"
										pattern="yyyy-MM-dd HH:mm" />
								</p>
								<p>
									举办地点：${recruit.address }
							...
							<div class="alert alert-info" role="alert">
								...
								<p style="font-size: 16px">单位所在地：${enterprise.province}省 ${enterprise.city}市</p>
							...
							<div class="alert alert-danger" role="alert">
								<blockquote class="layui-text" style="font-size: 30px;">
									招聘内容：</blockquote>
								<p>
								<pre style="font-size: 16px">${recruit.content}</pre>
								</p>							
							</div>
						</div>
					</div>
